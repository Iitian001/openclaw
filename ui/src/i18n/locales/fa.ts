...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "عرض CSS اختیاری برای متن هم‌ترازشده وسط، مانند 960px، 82% یا min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی موقتاً در دسترس می‌ماند. آن را از طریق HTTPS یا localhost دوباره باز کنید تا با هویت دستگاه ایمن شود.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "گفت‌وگو شاخه‌ها را تغییر داد — بررسی و دوباره ارسال کنید.",
    },
    waitingForApproval: "در انتظار تأیید…",
    startupStatus: {
    ...
    sessionSharing: {
      menu: "اشتراک‌گذاری گفت‌وگو",
      current: "قابلیت مشاهده گفت‌وگو: {visibility}",
      ...
      readOnlyNotice: "فقط مالک گفت‌وگو و اعضا می‌توانند در این گفت‌وگو اقدام کنند.",
    },
