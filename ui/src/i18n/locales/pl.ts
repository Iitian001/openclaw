...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Opcjonalna szerokość CSS dla wyśrodkowanego zapisu, np. 960px, 82% lub min(1280px, 82%).",
      messageWidthInvalid:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Wątek przełączył gałęzie — sprawdź i wyślij ponownie.",
    },
    waitingForApproval: "Oczekiwanie na zatwierdzenie…",
    startupStatus: {
    ...
    messages: {
      ...
      replyingTo: "Odpowiadasz do {name}",
      rewind: "Cofnij",
