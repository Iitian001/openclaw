...
export const uk: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Цей застарілий браузер тимчасово залишається доступним. Відкрийте його знову через HTTPS або localhost, щоб убезпечити його ідентичністю пристрою.",
      pendingUnavailable: "Запит на з'єднання браузера ще не доступний. Повторіть спробу за мить.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілку розмови перемкнуто — перегляньте та надішліть повторно.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Лише власник розмови та учасники можуть діяти в цій розмові.",
    },
    ...
    sessionHeader: {
      ...
      copied: "Скопійовано",
      incognito: "Розмова в режимі анонімності",
