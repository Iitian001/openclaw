...
export const tr: TranslationMap = {
  ...
  connection: {
    queuedCount: "{count} sıraya alındı",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Bu tarayıcının güncellemeden sonra tek seferlik cihaz onayına ihtiyacı var.",
      ...
      pendingUnavailable:
        "Tarayıcı eşleştirme isteği henüz mevcut değil. Birazdan yeniden deneyin.",
